...
Within the [Wiki of this repository there is a template for repository governance] (https://github.com/dustinswales/template/wiki/Governance) that you could customize for your application(s). 
